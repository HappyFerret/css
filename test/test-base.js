...
test('Warnings in bad-base.css', t => {
  ...
  .then(data => {
    ...
    t.is(warnings[14].rule, 'selector-class-pattern');
    t.is(warnings[15].rule, 'selector-class-pattern');
    t.is(warnings[16].rule, 'selector-class-pattern');
    t.is(warnings[17].rule, 'selector-class-pattern');
    t.is(warnings[18].rule, 'selector-class-pattern');
    t.is(warnings[19].rule, 'selector-class-pattern');
  });
